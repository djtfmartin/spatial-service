...
<html>
<head>
    <title>Import Expert Distribution</title>
...
<div class="container">
<h1>Import Expert Distribution</h1>
    ...
    <div role="tabpanel">
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#settings" aria-controls="settings" role="tab"
                                                      data-toggle="tab">Expert Distribution Layer</a></li>
                        ...
                        <tr><td class="col-md-2">
                            <label for="data_resource_uid">
                                <span style="color:red">
                                    Data Resource Uid [cannot be changed after imported]:
                                </span>
                                <br/>
                                This should correspond to UID for a data resource
                                that has been pre-registered in the Collectory
                            </label>
